...
public class HelloWorld extends PApplet
{
	...
	/** The map you will use to display your home town: Salt Lake City, Utah */ 
	UnfoldingMap map2;

	public void setup() {
		size(820, 600, P2D);  // Set up the Applet window to be 800x600
		...
		this.background(190.3f,128.7f,143.8f,6);
		...
		// 40.8 (latitude) and -111.9 (longitude) for salt lake city utah
		map2.zoomAndPanTo(zoomLevel, new Location(40.8f, -111.9f));
		
		// interactive feature for map2
